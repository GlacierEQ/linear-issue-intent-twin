"""Issue Intent Twin — SCAFFOLD STUB.

Company lens: Linear (independent; no affiliation).
Bottleneck: Agent-written issue/PR loops lose the original product intent.
...
class IssueIntentTwin:
    ...
    - `evaluate(req)` returns a IssueIntentTwinReceipt
    ...
    def evaluate(self, req: IssueIntentTwinRequest) -> IssueIntentTwinReceipt:
        reasons: list[str] = []
